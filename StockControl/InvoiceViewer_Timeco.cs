...
{
    public partial class InvoiceViewer_Timeco : Form
    {
        public static InvoiceViewer_Timeco instance;
        public Label estimateid;
        public InvoiceViewer_Timeco()
        {
            InitializeComponent();
            instance = this;
        ...
        public void ViewInvoiceReport()
        {
            ...
            reportViewer1.LocalReport.ReportPath = @"D:\\Projects\StockControl\StockControl\Invoice.rdlc";
        ...
        private void InvoiceViewer_Timeco_Load(object sender, EventArgs e)
        {
